...
int main(int argc, char *argv[]) {
    ...
    pcl::io::loadPCDFile((argc < 2) ? "bun0.pcd" : argv[1], *cloud);
    ...
    // pcl::concatenateFields(*cloud, *normals, *cloud_with_normals); // fix
    ...
    // 	printf("parts: %d\n", v);
    // }
    pcl::io::savePLYFile((argc < 3) ? "output_0.ply" : argv[2], triangles);
    printf("done\n");
    return 1;
}
